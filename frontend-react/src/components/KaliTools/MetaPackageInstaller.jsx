...
const METAPACKAGES = {
  blue: ['kali-linux-default', 'kali-linux-top10', 'kali-tools-forensics', 'kali-tools-passwords'],
  red: ['kali-linux-default', 'kali-linux-top10', 'kali-tools-exploitation', 'kali-tools-web'],
  purple: ['kali-linux-default', 'kali-linux-top10', 'kali-tools-forensics', 'kali-tools-exploitation'],
  wireless: ['kali-linux-wireless', 'kali-tools-wireless', 'kali-tools-sniffing-spoofing'],
  custom: []
};
...
const MetaPackageInstaller = () => {
  ...
  const handleInstall = async () => {
    ...
    setInstalling(true);
    try {
      await api.post('/api/kali-tools/install', {
        role,
          ...
          <div>
            ...
            {role === 'custom' ? (
              <textarea
                ...
                rows={3}
                placeholder="Ej: kali-linux-default kali-tools-forensics"
                value={customPkgs}
